...
router.post(
  ...
  authRateLimiter,
  validate(adminProfilePasswordChangeRequestSchema),
  adminController.requestPasswordChange,
);
router.post(
  '/profile/change-password/verify',
  authRateLimiter,
  validate(adminProfilePasswordChangeVerifySchema),
  adminController.verifyPasswordChange,
);
...
router.get(
  ...
  adminController.listNotificationRecipients,
);
router.post(
  '/notification-recipients',
  authorize(USER_ROLES.ADMIN),
  validate(notificationRecipientCreateSchema),
  adminController.createNotificationRecipient,
);
router.post(
  '/notification-recipients/verify',
  authorize(USER_ROLES.ADMIN),
  authRateLimiter,
  validate(notificationRecipientVerifySchema),
  adminController.verifyNotificationRecipient,
);
router.post(
  '/notification-recipients/test',
  authorize(USER_ROLES.ADMIN),
  adminController.sendNotificationRecipientTest,
);
router.patch(
  '/notification-recipients/:uuid/toggle',
  authorize(USER_ROLES.ADMIN),
  validate(uuidOnlySchema),
  adminController.toggleNotificationRecipient,
);
router.delete(
  '/notification-recipients/:uuid',
  authorize(USER_ROLES.ADMIN),
  validate(uuidOnlySchema),
  adminController.deleteNotificationRecipient,
);
...
router.patch(
  '/homepage/sections/:sectionId/toggle',
  authorize(USER_ROLES.ADMIN),
  validate(homepageSectionToggleSchema),
  adminController.toggleHomepageSection,
);
router.patch(
  '/homepage/sections/reorder',
  authorize(USER_ROLES.ADMIN),
  validate(homepageSectionReorderSchema),
  adminController.reorderHomepageSections,
);
router.post(
  '/homepage/sections/:sectionId/items',
  authorize(USER_ROLES.ADMIN),
  validate(homepageFeaturedItemSchema),
  adminController.addHomepageFeaturedItem,
);
router.delete(
  '/homepage/sections/:sectionId/items/:itemId',
  authorize(USER_ROLES.ADMIN),
  validate(homepageFeaturedItemDeleteSchema),
  adminController.removeHomepageFeaturedItem,
);
router.patch(
  '/homepage/sections/:sectionId/items/reorder',
  authorize(USER_ROLES.ADMIN),
  validate(homepageFeaturedItemReorderSchema),
  adminController.reorderHomepageFeaturedItems,
);

router.get(
  '/blog/categories',
  requirePermission('blog:read'),
  validate(listGenericSchema),
  adminController.listBlogCategories,
);
router.post(
  '/blog/categories',
  requirePermission('blog:create'),
  validate(categorySchema),
  adminController.createBlogCategory,
);
router.patch(
  '/blog/categories/:uuid',
  requirePermission('blog:update'),
  validate(updateCategorySchema),
  adminController.updateBlogCategory,
);
router.delete(
  '/blog/categories/:uuid',
  requirePermission('blog:delete'),
  validate(uuidOnlySchema),
  adminController.deleteBlogCategory,
);
...
router.patch(
  '/blog/posts/:uuid/publish',
  requirePermission('blog:update'),
  validate(uuidOnlySchema),
  adminController.publishBlogPost,
);
router.patch(
  '/blog/posts/:uuid/unpublish',
  requirePermission('blog:update'),
  validate(uuidOnlySchema),
  adminController.unpublishBlogPost,
);
router.patch(
  '/blog/posts/:uuid/archive',
  requirePermission('blog:update'),
  validate(uuidOnlySchema),
  adminController.archiveBlogPost,
);
router.patch(
  '/blog/posts/:uuid/featured',
  requirePermission('blog:update'),
  validate(featuredToggleSchema),
  adminController.updateBlogPostFeatured,
);
router.delete(
  '/blog/posts/:uuid',
  requirePermission('blog:delete'),
...
router.get(
  ...
  validate(listGenericSchema),
  adminController.listProductCategories,
);
router.post(
  '/products/categories',
...
router.get(
  ...
  requirePermission('products:read'),
  validate(listGenericSchema),
  adminController.listCollections,
);
router.post(
  '/products/collections',
  requirePermission('products:create'),
...
router.put(
  '/products/collections/:uuid/products',
  requirePermission('products:update'),
  validate(collectionProductsSchema),
...
router.get(
  '/products/export/inventory.xlsx',
  requirePermission('products:read'),
  adminController.downloadInventoryExport,
);
router.patch(
  '/products/bulk/archive',
  requirePermission('products:delete'),
  validate(productBulkSchema),
  adminController.archiveProductsBulk,
);
router.patch(
  '/products/bulk/restore',
  requirePermission('products:update'),
  validate(productBulkSchema),
  adminController.restoreProductsBulk,
);
router.delete(
  '/products/bulk/permanent',
  requirePermission('products:delete'),
  validate(productPermanentDeleteSchema),
  adminController.permanentlyDeleteProductsBulk,
);
router.get(
  '/products',
  requirePermission('products:read'),
...
router.patch(
  '/products/:uuid/featured',
  requirePermission('products:update'),
  validate(featuredToggleSchema),
  adminController.updateProductFeatured,
);
router.delete(
  '/products/:uuid',
  requirePermission('products:delete'),
...
router.get(
  '/quotes',
  authorize(USER_ROLES.ADMIN),
  validate(quoteListSchema),
  adminController.listQuotes,
);
router.patch(
  '/quotes/archive',
  authorize(USER_ROLES.ADMIN),
  validate(quoteBulkArchiveSchema),
  adminController.archiveQuotes,
);
router.patch(
  '/quotes/restore',
  authorize(USER_ROLES.ADMIN),
  validate(quoteBulkRestoreSchema),
  adminController.restoreQuotes,
);
router.get(
  '/quotes/:uuid',
  authorize(USER_ROLES.ADMIN),
  validate(uuidOnlySchema),
  adminController.getQuote,
);
router.patch(
  '/quotes/:uuid/status',
  authorize(USER_ROLES.ADMIN),
...
router.get(
  ...
  adminController.interestAnalytics,
);
router.get(
  '/logs/email',
  authorize(USER_ROLES.ADMIN),
  validate(adminLogListSchema),
  adminController.listEmailLogs,
);
router.get(
  '/logs/audit',
  authorize(USER_ROLES.ADMIN),
...
router.get(
  ...
  validate(listGenericSchema),
  adminController.listImportJobs,
);
router.get(
  '/imports/products/template',
  requirePermission('imports:read'),
  adminController.downloadProductImportTemplate,
);
router.post(
  ...
  validateUploadedXlsxFile,
  adminController.previewProductImport,
);
router.post(
  '/imports/products/:uuid/confirm',
  requirePermission('imports:create'),
  validate(uuidOnlySchema),
  adminController.confirmProductImport,
);
router.post(
  '/imports/products',
  requirePermission('imports:create'),
