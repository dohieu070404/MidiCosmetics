...
router.post('/login', requireTrustedOrigin, authRateLimiter, validate(loginSchema), authController.login);
router.post('/refresh', requireTrustedOrigin, authRateLimiter, validate(refreshTokenSchema), authController.refresh);
