        ...
        <Card className="w-full max-w-md rounded-[2rem]">
          <CardContent className="p-6 sm:p-8">
            <div className="mb-8 text-center">
              <div className="mx-auto inline-flex size-12 items-center justify-center rounded-full bg-secondary text-primary">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Chỉ dành cho chủ shop Midi Cosmetics quản lý sản phẩm và blog.
              </p>
            </div>
            <form className="grid gap-5" onSubmit={handleSubmit}>
              <label className="grid gap-2 text-sm font-medium text-foreground">
                Email
                <input
                  className="h-12 rounded-2xl border border-input bg-background px-4 text-sm outline-none transition-colors focus:border-primary focus:ring-2 focus:ring-ring/30"
                  name="email"
                  type="email"
                  value={form.email}
              ...
              <Button type="submit" size="lg" className="mt-2 w-full" disabled={loading}>
                {loading ? 'Đang đăng nhập...' : 'Vào trang quản trị'} <ArrowRight />
              </Button>
            </form>
          </CardContent>
        </Card>
