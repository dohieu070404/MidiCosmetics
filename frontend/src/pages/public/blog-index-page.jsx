    ...
    <PageShell className="py-10 sm:py-14 lg:py-20">
      <Container>
        ...
        <div className="mt-8 grid gap-3 rounded-[1.75rem] border border-border bg-card/70 p-4 sm:mt-10 md:grid-cols-4">
          <input value={search} onChange={(e) => updateParam('search', e.target.value)} placeholder="Tìm bài viết..." className="min-h-11 rounded-full border border-input bg-background px-4 py-2 text-sm md:col-span-2" />
