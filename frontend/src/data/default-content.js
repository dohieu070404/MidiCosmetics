...
export const DEFAULT_COLLECTIONS = Object.freeze([
  {
    uuid: 'collection-daily-ritual',
    slug: 'daily-ritual',
    name: 'Daily Ritual',
    description: 'Những món chăm sóc đủ dịu nhẹ để trở thành thói quen mỗi ngày.',
    coverImage: '/images/editorial/hero-skincare-2026.webp',
  },
  {
    uuid: 'collection-soft-colour',
    slug: 'soft-colour',
    name: 'Soft Colour',
    description: 'Màu sắc trong trẻo, dễ dùng và tôn sắc da tự nhiên.',
    coverImage: '/images/editorial/hero-makeup-2026.webp',
  },
]);
