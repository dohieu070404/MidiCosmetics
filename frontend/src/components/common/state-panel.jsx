...
export function StatePanel({
  ...
  return (
    <div
      className={`grid min-h-56 place-items-center rounded-2xl border border-dashed border-border bg-card/55 px-6 py-12 text-center shadow-sm ${className}`}
    >
      <div className="max-w-md">
        <Icon
          className={`mx-auto size-6 text-primary ${type === 'loading' ? 'animate-spin' : ''}`}
        />
