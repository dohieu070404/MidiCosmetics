...
export const PRODUCT_MENU_GROUPS = Object.freeze([
  Object.freeze({
    ...
    columns: Object.freeze([
      column("Làm sạch", [category("Tẩy trang", "tay-trang"), category("Sữa rửa mặt", "sua-rua-mat"), category("Toner", "toner")]),
      column("Phục hồi & dưỡng", [category("Serum", "serum"), category("Kem dưỡng", "kem-duong"), category("Mặt nạ", "mat-na"), category("Dán mụn", "dan-mun")]),
      column("Làm mới & bảo vệ", [category("Xịt khoáng", "xit-khoang"), category("Tẩy da chết", "tay-da-chet"), category("Kem chống nắng", "kem-chong-nang")]),
    ]),
  }),
  Object.freeze({
    id: "makeup",
    ...
    columns: Object.freeze([
      ...
      column("Lớp nền", [category("Cushion", "cushion"), category("Kem nền", "kem-nen"), category("Kem lót", "kem-lot"), category("Che khuyết điểm", "che-khuyet-diem"), category("Phấn phủ", "phan-phu"), category("Xịt khóa nền", "xit-khoa-nen")]),
      column("Mắt & chân mày", [category("Mascara", "mascara"), category("Kẻ mắt", "ke-mat"), category("Kẻ mày", "ke-may")]),
      column("Màu sắc & tạo khối", [category("Phấn mắt, má", "phan-mat-ma"), category("Khối & highlight", "khoi-highlihght")]),
    ]),
  }),
  Object.freeze({
    id: "body-hair",
    ...
    columns: Object.freeze([
      column("Chăm sóc cơ thể", [category("Kem body", "kem-body"), category("Sữa tắm", "sua-tam"), category("Tẩy da chết body", "tay-da-chet-body"), category("Tẩy lông", "tay-long")]),
      column("Chăm sóc cá nhân", [category("Body mist", "body-mist"), category("Lăn nách", "lan-nach"), category("Dung dịch vệ sinh", "ddvs"), category("Kem đánh răng", "kem-danh-rang")]),
      column("Tóc & da đầu", [category("Dầu gội", "dau-goi"), category("Chăm sóc da đầu", "da-dau")]),
    ]),
  }),
  Object.freeze({
    id: "fragrance",
    ...
    columns: Object.freeze([
      column("Nước hoa", [category("Tất cả nước hoa", "nuoc-hoa")]),
    ]),
  }),
  Object.freeze({
    id: "accessories",
    ...
    columns: Object.freeze([
      column("Dụng cụ trang điểm", [category("Phụ kiện", "phu-kien"), category("Mút trang điểm", "mut-trang-diem"), category("Kẹp mi", "kep-mi"), category("Kích mí", "kich-mi")]),
...
export const PRODUCT_GROUP_BY_ID = Object.freeze(Object.fromEntries(PRODUCT_MENU_GROUPS.map((group) => [group.id, group])));
